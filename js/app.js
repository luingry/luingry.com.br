...
(function (EasterEgg) {
    /* simbolos aceitos */
    /* créditos da lib: https://github.com/gridonic/easter-egg.js*/
    /* Comandos disponívels: ['↑', '↑', '↓', '↓', '←', '→', '→', '←', 'tap', 'tap']*/
    new EasterEgg({
        patternTouch: ['tap', 'tap', 'tap'],
        onSuccess: function() {
            $("#logo-container").toggleClass("cheat-enabled-mobile");
        }
    });
})(window.easterEgg);
...
cheet('↑ ↑ ↓ ↓ ← → ← → b a', function () {
    ...
    $("#logo-container").toggleClass("cheat-enabled");
